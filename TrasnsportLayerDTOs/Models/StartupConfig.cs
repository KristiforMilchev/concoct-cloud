namespace  TransportLayer.Models
{
    ...
    public partial class StartupConfig
    {
        public static StartupConfig FromJson(string json) => JsonConvert.DeserializeObject<StartupConfig>(json,  TransportLayer.Models.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this StartupConfig self) => JsonConvert.SerializeObject(self,  TransportLayer.Models.Converter.Settings);
    }
