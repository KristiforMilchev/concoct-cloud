namespace Platform.ViewComponents
{
    ...
    public class DocumentationNavigationViewComponent : ViewComponent
    {
        ...
        public DocumentationNavigationViewComponent(DatabaseContext context, IConfiguration config, IAutherizationManager autherizationManager, IHttpContextAccessor httpContextAccessor)
        {
            Context = context;
