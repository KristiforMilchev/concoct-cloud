...
namespace Platform.ViewComponents
{
    ...
    public class GetTagPropertiesViewComponent : ViewComponent
    {
        ...
        private int UserId;
        public GetTagPropertiesViewComponent(DatabaseContext context, IConfiguration config, IAutherizationManager autherizationManager, IHttpContextAccessor httpContextAccessor)
        {
            Context = context;
