...
namespace Platform.ViewComponents
{
    ...
    public class DesignerComponentsViewComponent : ViewComponent
    {
        ...
        public DesignerComponentsViewComponent(DatabaseContext context, IConfiguration config, IAutherizationManager autherizationManager, IHttpContextAccessor httpContextAccessor)
        {
            Context = context;
