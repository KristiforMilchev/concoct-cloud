namespace Platform.ViewComponents
{
    ...
    public class ChatSettingsViewComponent : ViewComponent
    {
        ...
        public ChatSettingsViewComponent(DatabaseContext context, IConfiguration config, IAutherizationManager autherizationManager, IHttpContextAccessor httpContextAccessor)
        {
            Context = context;
