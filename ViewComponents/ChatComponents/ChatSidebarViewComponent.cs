namespace Platform.ViewComponents
{
    ...
    public class ChatSidebarViewComponent : ViewComponent 
    {
        ...
        public ChatSidebarViewComponent(DatabaseContext context, IConfiguration config, IAutherizationManager autherizationManager, IHttpContextAccessor httpContextAccessor)
        {
            Context = context;
