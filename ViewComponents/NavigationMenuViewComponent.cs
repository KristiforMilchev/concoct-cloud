namespace Platform.ViewComponents
{
    ...
    public class NavigationMenuViewComponent : ViewComponent
    {
        ...
        public NavigationMenuViewComponent(DatabaseContext context, IConfiguration config, IAutherizationManager autherizationManager, IHttpContextAccessor httpContextAccessor)
        {
            Context = context;
